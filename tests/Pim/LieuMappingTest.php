...
final class LieuMappingTest extends KernelTestCase
{
    public function testBibleFieldsAndLocalisationAreMappedSeparately(): void
    {
        ...
        // 59 = 58 champs Bible + les horaires par jour (dispoHorairesJours, JSON,
        // source unique — l'amplitude globale et le jour texte legacy ont disparu).
        self::assertCount(59, $lieuMetadata->getFieldNames());
        ...
        foreach (['type', 'code', 'label', 'status', 'version', 'publishedAt', 'archivedAt', 'mergedIntoId', 'validationRequestedAt', 'validationRequestedBy', 'validationReviewedAt', 'validationReviewedBy', 'validationFeedback', 'businessPremium', 'partenaireBp'] as $field) {
        ...
        // verification trace (score, date, fingerprint, proposition, écart),
        // id and timestamps.
        self::assertCount(20, $localisationMetadata->getFieldNames());
