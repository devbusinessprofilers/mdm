...
final class OcrUploadType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('document', FileType::class, ['label' => 'PDF à analyser', 'constraints' => [new File(maxSize: $this->parametres->int('ocr.pdf_poids_max_mo').'M', mimeTypes: ['application/pdf'], mimeTypesMessage: 'Un PDF réel est requis.')]])
