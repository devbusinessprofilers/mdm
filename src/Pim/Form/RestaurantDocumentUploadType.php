...
/**
 * Dépôt documentaire du Restaurant — pendant de LieuDocumentUploadType, la
 * salle rattachée étant une RestaurantSalle. Utilisé par la vignette de la
 * matrice « Salles & capacités » (contrôleur salle-plan) et soumis en fetch.
 *
 * @extends AbstractType<array<string, mixed>>
 */
final class RestaurantDocumentUploadType extends AbstractType
{
