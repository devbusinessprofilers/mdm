...
class RestaurantLocalisationType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->addDependent('hasReducedMobilityToilets', 'hasReducedMobilityAccess', $this->isReducedMobilityAccess(...));
    }

    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => RestaurantLocalisationDTO::class,
            'label_format' => 'form.sheet.restaurant.localisation.%name%.label',
        ]);
    }
