...
final class AdminController extends AbstractController
{
    ...
    public function __invoke(Request $request, AdminPageCatalog $catalog, AdminEventCatalog $eventCatalog, AdminEventMonitor $eventMonitor, AdminWorkflowCatalog $workflowCatalog): Response
    {
        return $this->render('pim/admin.html.twig', [
            ...
            'workflow_catalog' => $workflowCatalog->workflows(),
        ]);
    }
}
