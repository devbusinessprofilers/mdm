...
final class AdminController extends AbstractController
{
    ...
    public function __invoke(AdminPageCatalog $catalog, AdminEventCatalog $eventCatalog, AdminEventMonitor $eventMonitor): Response
    {
        return $this->render('pim/admin.html.twig', [
            'page_groups' => $catalog->groups(),
            'event_catalog' => $eventCatalog->events(),
            'event_monitor' => $eventMonitor->snapshot(),
        ]);
    }
}
