...
final class RestaurantImportSchema extends AbstractFicheImportSchema
{
    ...
    public function ficheColumns(): array
    {
        return [
            ...
            new ColumnDefinition('heure_ouverture', ColumnKind::Time, 'heureOuverture', help: 'format HH:MM'),
            new ColumnDefinition('heure_fermeture', ColumnKind::Time, 'heureFermeture', help: 'format HH:MM'),
