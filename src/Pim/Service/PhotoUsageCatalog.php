...
final class PhotoUsageCatalog
{
    ...
    /**
     * Photo rattachée à une salle : salle de réunion d'un Lieu ou salle d'un
     * Restaurant. Un seul code pour toutes les gammes.
     */
    public const SALLE = 'CONFIG_PHOTO_SALLE';
