...
final class FicheCollaborateurRepository extends ServiceEntityRepository
{
    ...
    {
        parent::__construct($registry, FicheCollaborateur::class);
    }

    public function findOneByEmail(string $email): ?FicheCollaborateur
    {
        return $this->findOneBy(['email' => FicheCollaborateur::normalizeEmail($email)]);
    }

    /** @return list<FicheCollaborateur> */
    public function findPage(int $limit, int $offset): array
    {
        return $this->findBy([], ['email' => 'ASC'], $limit, $offset);
    }
