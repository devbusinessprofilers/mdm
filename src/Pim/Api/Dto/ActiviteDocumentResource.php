...
/**
 * Opérations documentaires des Activités (`/v1/activites/{activiteId}/documents…`) :
 * supports commerciaux seulement. La représentation est FicheDocumentResource,
 * le traitement FicheDocumentProcessor.
 */
#[ApiResource(
    shortName: 'ActiviteDocument',
...
final class ActiviteDocumentResource
{
}
