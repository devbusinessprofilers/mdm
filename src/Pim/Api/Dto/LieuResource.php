    ...
    operations: [
        new GetCollection(
            ...
            openapi: new Operation(
                ...
                parameters: [
                    new Parameter('status', 'query', 'Filtre de statut', schema: ['type' => 'string', 'enum' => ['en_cours', 'en_attente_validation', 'publiee', 'archivee']]),
                    new Parameter('cursor', 'query', 'Curseur opaque retourné par la page précédente', schema: ['type' => 'string']),
                    new Parameter('limit', 'query', 'Nombre de résultats, de 1 à 100', schema: ['type' => 'integer', 'minimum' => 1, 'maximum' => 100, 'default' => 50]),
                ],
                security: [['bearerAuth' => []]],
            ),
        ),
        new Get(
            ...
            openapi: new Operation(tags: ['Lieux'], summary: 'Consulter un lieu', security: [['bearerAuth' => []]]),
        ),
        new Patch(
            uriTemplate: '/v1/lieux/{id}',
            requirements: ['id' => '[0-9A-HJKMNP-TV-Z]{26}'],
            ...
            openapi: new Operation(
                ...
                description: 'La modification replace la fiche en brouillon. If-Match doit contenir la version lue.',
                parameters: [new Parameter('If-Match', 'header', 'Version courante, par exemple "3"', true, schema: ['type' => 'string'])],
                security: [['bearerAuth' => []]],
            ),
        ),
        new Post(
            uriTemplate: '/v1/lieux/{lieuId}/medias',
            uriVariables: ['lieuId' => new Link(fromClass: self::class, identifiers: ['id'], compositeIdentifier: false)],
            input: false,
            ...
            openapi: new Operation(
                ...
                parameters: [new Parameter('If-Match', 'header', 'Version courante du lieu', true, schema: ['type' => 'string'])],
                requestBody: new RequestBody('Fichier image et métadonnées', new \ArrayObject([
                    'multipart/form-data' => ['schema' => ['type' => 'object', 'required' => ['photo'], 'properties' => [
                        'photo' => ['type' => 'string', 'format' => 'binary'],
                        'usage' => ['type' => 'string', 'default' => 'PHOTO_DIVERSE'],
        ...
        new Put(
            ...
            read: false,
            processor: LieuMediaProcessor::class,
            openapi: new Operation(tags: ['Médias Lieux'], summary: 'Réordonner toutes les images', parameters: [new Parameter('If-Match', 'header', 'Version courante du lieu', true, schema: ['type' => 'string'])], security: [['bearerAuth' => []]]),
        ),
        new Patch(
            uriTemplate: '/v1/lieux/{lieuId}/medias/{resourceId}',
            uriVariables: [
                'lieuId' => new Link(fromClass: self::class, identifiers: ['id'], compositeIdentifier: false),
            ...
            read: false,
            processor: LieuMediaProcessor::class,
            openapi: new Operation(tags: ['Médias Lieux'], summary: 'Modifier les métadonnées, le recadrage ou la rotation', parameters: [new Parameter('If-Match', 'header', 'Version courante du lieu', true, schema: ['type' => 'string'])], security: [['bearerAuth' => []]]),
        ),
        new Post(
            ...
            openapi: new Operation(
                ...
                parameters: [new Parameter('If-Match', 'header', 'Version courante du lieu', true, schema: ['type' => 'string'])],
                requestBody: new RequestBody('Nouveau fichier source', new \ArrayObject([
                    'multipart/form-data' => ['schema' => ['type' => 'object', 'required' => ['photo'], 'properties' => ['photo' => ['type' => 'string', 'format' => 'binary']]]],
                ]), true),
                security: [['bearerAuth' => []]],
            ),
        ),
        new Delete(
            ...
            read: false,
            processor: LieuMediaProcessor::class,
            openapi: new Operation(tags: ['Médias Lieux'], summary: 'Supprimer une image', parameters: [new Parameter('If-Match', 'header', 'Version courante du lieu', true, schema: ['type' => 'string'])], security: [['bearerAuth' => []]]),
        ),
    ],
)]
