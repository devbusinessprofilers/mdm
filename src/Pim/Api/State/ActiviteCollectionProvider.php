...
/** @implements ProviderInterface<ActiviteListResource> */
final readonly class ActiviteCollectionProvider implements ProviderInterface
{
    ...
    /** @return list<ActiviteListResource> */
    public function provide(
        ...
        try {
            ...
            throw new ApiProblemException(400, 'invalid_cursor', $e->getMessage());
        }
        $page = $this->activities->findListPage($cursor, $limit, $status);
