...
final readonly class ActiviteDocumentProcessor implements ProcessorInterface
{
    ...
    private function create(Activite $a): LieuDocumentResource
    {
    ...
    private function metadata(
        ...
        $this->access->requireWrite($d);
        $rightsWereGranted = $d->rightsGranted();
        ...
        if (
            ...
            throw new ApiProblemException(422, 'invalid_document_usage', 'Une Activité accepte uniquement les supports commerciaux.');
        }
        if (
            ...
            throw new ApiProblemException(422, 'foreign_room', 'Un support Activité ne peut pas être rattaché à une salle.');
        }
    ...
    private function upload(UploadedFile $file, Activite $a): MediaAsset
    {
        try {
