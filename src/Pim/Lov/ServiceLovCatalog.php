...
final class ServiceLovCatalog
{
    ...
    public static function sousPrestationValueCode(string $attributeCode, int $id): string
    {
        ...
        throw new \UnexpectedValueException('Identifiant de sous-prestation Service inconnu.');
    }
    ...
    public static function valueCode(int $id): string
    {
        ...
        throw new \UnexpectedValueException('Identifiant de prestation Service inconnu.');
    }
