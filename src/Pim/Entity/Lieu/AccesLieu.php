...
#[ORM\Entity]
#[ORM\Table(name: 'pim_acces_lieu')]
#[ORM\Index(name: 'IDX_PIM_ACCESS_ORDERED', columns: ['lieu_id', 'type', 'position', 'id'])]
#[ORM\Index(name: 'IDX_PIM_ACCESS_REVERSE', columns: ['type', 'lieu_id'])]
...
class AccesLieu
{
    ...
    #[ORM\Column(length: 32, enumType: TypeAccesLieu::class)]
    private TypeAccesLieu $type = TypeAccesLieu::Gare;
