/*
 * Alias du catalogue français, enregistré sous le code que réclame le
 * contrôleur `wysiwyg` du portail : il demande `fr-FR` (trait d'union) là où
 * TinyMCE nomme ses paquets `fr_FR` (souligné). Sans cet alias, la requête
 * `langs/fr-FR.js` part en 404 et l'interface retombe en anglais — c'est le
 * cas aujourd'hui sur le portail aussi.
 *
 * À supprimer le jour où le contrôleur demandera `fr_FR`.
 */
