...
final class Version20260729152000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($this->foreignKeyExists('pim_fiche_attribute_value', 'FK_PIM_FAV_VALUE')) {
            $this->addSql('ALTER TABLE pim_fiche_attribute_value DROP FOREIGN KEY FK_PIM_FAV_VALUE');
        }
        if ($this->indexExists('pim_fiche_attribute_value', 'IDX_80EB6BEBDF522508')) {
        ...
        if ($this->indexExists('pim_ressource_lieu', 'IDX_PIM_RESSOURCE_USAGE')) {
