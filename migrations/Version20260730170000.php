...
final class Version20260730170000 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(
            'ALTER TABLE dam_media_asset DROP error_message, DROP processed_at, DROP deleted_at',
        );
        $this->addSql(
            'ALTER TABLE pim_ressource_lieu DROP rights_granted, DROP rights_granted_at, DROP rights_granted_by, DROP source, DROP crop_x, DROP crop_y, DROP crop_width, DROP crop_height, DROP rotation',
        );
    }
}
